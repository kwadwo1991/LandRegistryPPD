      ...
      <div className="max-w-sm w-full bg-white rounded-2xl shadow-lg p-8">
        ...
        <form>
          <div className="mb-4">
            ...
            <input className="w-full px-4 py-3 rounded-lg bg-gray-100 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-green-500" id="email" type="email" placeholder="Enter your email" />
          </div>
